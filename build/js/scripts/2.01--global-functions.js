...
if ($('body').hasClass('single-companies') ) {

  $('html').addClass('single-companies');
...
var perfectVideo = document.getElementById("m-video-player");

function playPause() {
  if (perfectVideo.paused)
    perfectVideo.play();
  else
    perfectVideo.pause();
}

$(".video-control").click(function(event){

  event.preventDefault();
  $(".m-video-player, .a-video-close").toggleClass('active');
